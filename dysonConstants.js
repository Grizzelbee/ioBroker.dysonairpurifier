...
module.exports.DATAPOINTS = [
    ...
    ['hmod' , 'HeaterMode'                , 'Heating Mode [ON/OFF]'                                                         , 'boolean', 'true',  'switch'            ,'', {'OFF': 'Off', 'HEAT': 'On'} ],
    ['hmax' , 'TemperatureTarget'         , 'Target temperature for heating'                                                , 'string',  'true',  'value.temperature' ,'' ],
    ['hume' , 'HumidificationMode'        , 'HumidificationMode Switch [ON/OFF]'                                            , 'boolean', 'true', 'switch'             ,'', {'OFF': 'Off', 'HUMD': 'On'} ],
    ...
    ['amf4' , 'AFM_OVER_TEMP'                       , 'AFM_OVER_TEMP'                             , 'boolean',  'false', 'indicator', '' ],
    ['amf5' , 'AFM_START_UP'                        , 'AFM_START_UP'                              , 'boolean',  'false', 'indicator', '' ],
    ['amf6' , 'AFM_SPEED_FDBK'                      , 'AFM_SPEED_FDBK'                            , 'boolean',  'false', 'indicator', '' ],
    ['amf7' , 'AFM_OVER_CURRENT'                    , 'AFM_OVER_CURRENT'                          , 'boolean',  'false', 'indicator', '' ],
    ['amf8' , 'AFM_SW_ERROR'                        , 'AFM_SW_ERROR'                              , 'boolean',  'false', 'indicator', '' ],
    ['bosl' , 'BARREL_OSCILLATION_LEFT'             , 'Barrel oscillation left blocked'           , 'boolean',  'false', 'indicator', '' ],
    ['bosr' , 'BARREL_OSCILLATION_RIGHT'            , 'Barrel oscillation right blocked'          , 'boolean',  'false', 'indicator', '' ],
    ['com1' , 'COMMS_AFM'                           , 'COMMS_AFM'                                 , 'boolean',  'false', 'indicator', '' ],
    ['sen1' , 'DUST_SENSOR'                         , 'Dust sensor failure'                       , 'boolean',  'false', 'indicator', '' ],
    ['sen2' , 'GAS_SENSOR'                          , 'Gas sensor failure'                        , 'boolean',  'false', 'indicator', '' ],
    ['sen3' , 'TEMPERATURE_SENSOR'                  , 'Temperature sensor failure'                , 'boolean',  'false', 'indicator', '' ],
    ['sen4' , 'HUMIDITY_SENSOR'                     , 'Humidity sensor failure'                   , 'boolean',  'false', 'indicator', '' ],
    ['etws' , 'EVAPORATION_TRAY_OVERFLOW_EXTENDED'  , 'EVAPORATION_TRAY_OVERFLOW_EXTENDED'        , 'boolean',  'false', 'indicator', '' ],
    ['wpmp' , 'WATER_PUMP_FAILURE'                  , 'A water pump failure has been detected.'   , 'boolean',  'false', 'indicator', '' ],
    ['prot' , 'PUMP_ROTOR'                          , 'Pump rotor failure'                        , 'boolean',  'false', 'indicator', '' ],
    ...
    ['etwd' , 'EVAPORATION_TRAY_OVERFLOW_DETECTED'  , 'EVAPORATION_TRAY_OVERFLOW_DETECTED'        , 'boolean',  'false', 'indicator', '' ],
    ['cnfg' , 'BLDC_CONFIG_ERROR'                   , 'BLDC_CONFIG_ERROR'                         , 'boolean',  'false', 'indicator', '' ],
    ['wdog' , 'WATCH_DOG_RESET'                     , 'WATCH_DOG_RESET'                           , 'boolean',  'false', 'indicator', '' ],
    ['ibus' , 'I2C_BUS'                             , 'I2C BUS failure'                           , 'boolean',  'false', 'indicator', '' ],
    ['ilss' , 'ILLEGAL_SYSTEM_STATE'                , 'Illegal system state'                      , 'boolean',  'false', 'indicator', '' ],
    ['hioc' , 'GEN1_HEATER_INPUT_OVER_CURRENT'      , 'GEN1_HEATER_INPUT_OVER_CURRENT'            , 'boolean',  'false', 'indicator', '' ],
    ['hilc' , 'GEN1_HEATER_INPUT_LOW_CURRENT'       , 'GEN1_HEATER_INPUT_LOW_CURRENT'             , 'boolean',  'false', 'indicator', '' ],
    ['htri' , 'GEN1_HEATER_TRIAC'                   , 'GEN1_HEATER_TRIAC'                         , 'boolean',  'false', 'indicator', '' ],
    ['hamb' , 'GEN1_HEATER_AMBIENT_TEMPERATURE_LOSS', 'GEN1_HEATER_AMBIENT_TEMPERATURE_LOSS'      , 'boolean',  'false', 'indicator', '' ],
    ['povi' , 'GEN1_HEATER_PLUG_OVER_CURRENT'       , 'GEN1_HEATER_PLUG_OVER_CURRENT'             , 'boolean',  'false', 'indicator', '' ],
    ['hctf' , 'GEN1_HEATER_TRIAC_COMMS'             , 'GEN1_HEATER_TRIAC_COMMS'                   , 'boolean',  'false', 'indicator', '' ],
    ['hvmi' , 'GEN1_HEATER_TRIAC_VARIANT'           , 'GEN1_HEATER_TRIAC_VARIANT'                 , 'boolean',  'false', 'indicator', '' ],
    ['tilt' , 'GEN1_HEATER_TILT_DETECTION'          , 'GEN1_HEATER_TILT_DETECTION'                , 'boolean',  'false', 'indicator', '' ],
    ['ht01' , 'GEN2_HEATER_INPUT_OVER_CURRENT'      , 'GEN2_HEATER_INPUT_OVER_CURRENT'            , 'boolean',  'false', 'indicator', '' ],
    ['ht02' , 'GEN2_HEATER_INPUT_LOW_CURRENT'       , 'GEN2_HEATER_INPUT_LOW_CURRENT'             , 'boolean',  'false', 'indicator', '' ],
    ['ht03' , 'GEN2_HEATER_TRIAC'                   , 'GEN2_HEATER_TRIAC'                         , 'boolean',  'false', 'indicator', '' ],
    ['ht04' , 'GEN2_HEATER_PLUG_OVER_CURRENT'       , 'GEN2_HEATER_PLUG_OVER_CURRENT'             , 'boolean',  'false', 'indicator', '' ],
    ['ht05' , 'GEN2_HEATER_TRIAC_VARIANT_MISMATCH'  , 'GEN2_HEATER_TRIAC_VARIANT_MISMATCH'        , 'boolean',  'false', 'indicator', '' ],
    ['ht06' , 'GEN2_HEATER_AMBIENT_TEMPERATURE_LOSS', 'GEN2_HEATER_AMBIENT_TEMPERATURE_LOSS'      , 'boolean',  'false', 'indicator', '' ],
    ['ht07' , 'GEN2_HEATER_TILT_SENSOR'             , 'GEN2_HEATER_TILT_SENSOR'                   , 'boolean',  'false', 'indicator', '' ],
    ['ht08' , 'GEN2_HEATER_ILLEGAL_COUNTRY'         , 'GEN2_HEATER_ILLEGAL_COUNTRY'               , 'boolean',  'false', 'indicator', '' ],
    ['ht09' , 'GEN2_HEATER_VARIANT_ID_ERROR'        , 'GEN2_HEATER_VARIANT_ID_ERROR'              , 'boolean',  'false', 'indicator', '' ],
    ['ht0a' , 'GEN2_HEATER_CURRENT_SENSOR'          , 'GEN2_HEATER_CURRENT_SENSOR'                , 'boolean',  'false', 'indicator', '' ],
    ['dsts' , 'PARTICLE_SENSOR'                     , 'Particle sensor failure'                   , 'boolean',  'false', 'indicator', '' ],
    ['vocs' , 'VOC_SENSOR'                          , 'VOC Sensor failure'                        , 'boolean',  'false', 'indicator', '' ],
    ['t&hs' , 'TEMPERATURE_HUMIDITY_SENSOR'         , 'Temperature&Humidity sensor failure'       , 'boolean',  'false', 'indicator', '' ],
    ['fmco' , 'MOTOR_CONTROLLER'                    , 'Motor controller failure'                  , 'boolean',  'false', 'indicator', '' ],
    ['stto' , 'BLDC_STALL_TIMEOUT'                  , 'BLDC_STALL_TIMEOUT'                        , 'boolean',  'false', 'indicator', '' ],
    ['hall' , 'BLDC_HALL_MONITOR'                   , 'BLDC_HALL_MONITOR'                         , 'boolean',  'false', 'indicator', '' ],
    ['hamp' , 'BLDC_OVER_CURRENT'                   , 'BLDC_OVER_CURRENT'                         , 'boolean',  'false', 'indicator', '' ],
    ['stal' , 'BLDC_STALL_CURRENT'                  , 'BLDC_STALL_CURRENT'                        , 'boolean',  'false', 'indicator', '' ],
    ['shrt' , 'BLDC_SHORT_CURRENT'                  , 'BLDC_SHORT_CURRENT'                        , 'boolean',  'false', 'indicator', '' ],
    ['ste1' , 'PAN_OSCILLATION'                     , 'PAN Oscillation failure'                   , 'boolean',  'false', 'indicator', '' ]
];