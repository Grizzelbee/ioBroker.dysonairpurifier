...
module.exports.DATAPOINTS = [
    ...
    ['amf1' , 'AFM_FOC_DURATION'                    , ''                 , 'string',  'false', 'value'             ,'' ],
    ['amf2' , 'AFM_OVER_VOLT'                       , ''                 , 'string',  'false', 'value'             ,'' ],
    ['amf3' , 'AFM_UNDER_VOLT'                      , ''                 , 'string',  'false', 'value'             ,'' ],
    ['amf4' , 'AFM_OVER_TEMP'                       , ''                 , 'string',  'false', 'value'             ,'' ],
    ['amf5' , 'AFM_START_UP'                        , ''                 , 'string',  'false', 'value'             ,'' ],
    ['amf6' , 'AFM_SPEED_FDBK'                      , ''                 , 'string',  'false', 'value'             ,'' ],
    ['amf7' , 'AFM_OVER_CURRENT'                    , ''                 , 'string',  'false', 'value'             ,'' ],
    ['amf8' , 'AFM_SW_ERROR'                        , ''                 , 'string',  'false', 'value'             ,'' ],
    ['bosl' , 'BARREL_OSCILLATION_LEFT'             , ''                 , 'string',  'false', 'value'             ,'' ],
    ['bosr' , 'BARREL_OSCILLATION_RIGHT'            , ''                 , 'string',  'false', 'value'             ,'' ],
    ['sen1' , 'DUST_SENSOR'                         , ''                 , 'string',  'false', 'value'             ,'' ],
    ['sen2' , 'GAS_SENSOR'                          , ''                 , 'string',  'false', 'value'             ,'' ],
    ['sen3' , 'TEMPERATURE_SENSOR'                  , ''                 , 'string',  'false', 'value'             ,'' ],
    ['sen4' , 'HUMIDITY_SENSOR'                     , ''                 , 'string',  'false', 'value'             ,'' ],
    ['etws' , 'EVAPORATION_TRAY_OVERFLOW_EXTENDED'  , ''                 , 'string',  'false', 'value'             ,'' ],
    ['wpmp' , 'WATER_PUMP_FAILURE'                  , ''                 , 'string',  'false', 'value'             ,'' ],
    ['prot' , 'PUMP_ROTOR'                          , ''                 , 'string',  'false', 'value'             ,'' ],
    ['uled' , 'UVC_LED'                             , 'UV sanitizing LED'  , 'string',  'false', 'value'             ,'' ],
    ['fltr' , 'FILTER_REPLACEMENT'                  , ''                 , 'string',  'false', 'value'             ,'' ],
    ['tnke' , 'TANK_EMPTY'                          , ''                 , 'string',  'false', 'value'             ,'' ],
    ['tnkp' , 'TANK_UNDETECTED'                     , ''                 , 'string',  'false', 'value'             ,'' ],
    ['cldu' , 'CLEAN_CYCLE_OVERDUE'                 , ''                 , 'string',  'false', 'value'             ,'' ],
    ['etwd' , 'EVAPORATION_TRAY_OVERFLOW_DETECTED'  , ''                 , 'string',  'false', 'value'             ,'' ],
    ['cnfg' , 'BLDC_CONFIG_ERROR'                   , ''                 , 'string',  'false', 'value'             ,'' ],
    ['wdog' , 'WATCH_DOG_RESET'                     , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ibus' , 'I2C_BUS'                             , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ilss' , 'ILLEGAL_SYSTEM_STATE'                , ''                 , 'string',  'false', 'value'             ,'' ],
    ['hioc' , 'GEN1_HEATER_INPUT_OVER_CURRENT'      , ''                 , 'string',  'false', 'value'             ,'' ],
    ['hilc' , 'GEN1_HEATER_INPUT_LOW_CURRENT'       , ''                 , 'string',  'false', 'value'             ,'' ],
    ['htri' , 'GEN1_HEATER_TRIAC'                   , ''                 , 'string',  'false', 'value'             ,'' ],
    ['hamb' , 'GEN1_HEATER_AMBIENT_TEMPERATURE_LOSS', ''                 , 'string',  'false', 'value'             ,'' ],
    ['povi' , 'GEN1_HEATER_PLUG_OVER_CURRENT'       , ''                 , 'string',  'false', 'value'             ,'' ],
    ['hctf' , 'GEN1_HEATER_TRIAC_COMMS'             , ''                 , 'string',  'false', 'value'             ,'' ],
    ['hvmi' , 'GEN1_HEATER_TRIAC_VARIANT'           , ''                 , 'string',  'false', 'value'             ,'' ],
    ['tilt' , 'GEN1_HEATER_TILT_DETECTION'          , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht01' , 'GEN2_HEATER_INPUT_OVER_CURRENT'      , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht02' , 'GEN2_HEATER_INPUT_LOW_CURRENT'       , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht03' , 'GEN2_HEATER_TRIAC'                   , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht04' , 'GEN2_HEATER_PLUG_OVER_CURRENT'       , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht05' , 'GEN2_HEATER_TRIAC_VARIANT_MISMATCH'  , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht06' , 'GEN2_HEATER_AMBIENT_TEMPERATURE_LOSS', ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht07' , 'GEN2_HEATER_TILT_SENSOR'             , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht08' , 'GEN2_HEATER_ILLEGAL_COUNTRY'         , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht09' , 'GEN2_HEATER_VARIANT_ID_ERROR'        , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ht0a' , 'GEN2_HEATER_CURRENT_SENSOR'          , ''                 , 'string',  'false', 'value'             ,'' ],
    ['dsts' , 'PARTICLE_SENSOR'                     , ''                 , 'string',  'false', 'value'             ,'' ],
    ['vocs' , 'VOC_SENSOR'                          , ''                 , 'string',  'false', 'value'             ,'' ],
    ['t&hs' , 'TEMPERATURE_HUMIDITY_SENSOR'         , ''                 , 'string',  'false', 'value'             ,'' ],
    ['fmco' , 'MOTOR_CONTROLLER'                    , ''                 , 'string',  'false', 'value'             ,'' ],
    ['stto' , 'BLDC_STALL_TIMEOUT'                  , ''                 , 'string',  'false', 'value'             ,'' ],
    ['hall' , 'BLDC_HALL_MONITOR'                   , ''                 , 'string',  'false', 'value'             ,'' ],
    ['hamp' , 'BLDC_OVER_CURRENT'                   , ''                 , 'string',  'false', 'value'             ,'' ],
    ['stal' , 'BLDC_STALL_CURRENT'                  , ''                 , 'string',  'false', 'value'             ,'' ],
    ['shrt' , 'BLDC_SHORT_CURRENT'                  , ''                 , 'string',  'false', 'value'             ,'' ],
    ['ste1' , 'PAN_OSCILLATION'                     , ''                 , 'string',  'false', 'value'             ,'' ]
];